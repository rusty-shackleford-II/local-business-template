...
const Hero: React.FC<Props> = ({ hero, payment, isPreview, backgroundClass = 'bg-gradient-to-br from-gray-50 to-white', editable, onEdit, colorPalette }) => {
            ...
            <div className="order-1 lg:order-2">
              <div className="relative">
                ...
                {hero?.mediaType === 'video' && videoEmbedSrc ? (
                  ...
                  <div className="relative z-10 aspect-[4/3] lg:aspect-[16/10]">
                    {imageLoading && (
